...
/**
 * =========================================================
 * Section: Sidebar Active Menu Expansion (chg0238x)
 * Description: Expand only the menu matching backend $activeMenuId
 * =========================================================
 */
$(function () {
  var activeMenuId = $('.main-nav').data('active-menu-id');
  if (activeMenuId) {
    var $activeMenu = $('#menu_' + activeMenuId);
    $activeMenu.addClass('show').attr('aria-expanded', 'true');
