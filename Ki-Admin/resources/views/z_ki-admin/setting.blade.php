                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-4">
                                                <div class="">
                                                    ...
                                                    <select
                                                        class="select-language form-select select-basic"
                                                        name="state">
                                        ...
                                        <div class="col-xxl-6 mt-xxl-0 mt-5">
                                            ...
                                            <div class="form-selectgroup mt-5">
                                                <div class="select-item d-flex">
                                                    ...
                                                    <div class="ms-2">
                                                        <img src="{{asset('../assets/images/setting-app/visa-icon.png')}}"
                                                             alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-selectgroup mt-4">
                                                <div class="select-item d-flex">
                                                    ...
                                                    <div class="ms-2">
                                                        <img src="{{asset('../assets/images/setting-app/master-icon.png')}}"
                                                             alt="">
                                                    </div>
                                                </div>
                                            </div>
