                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            <div class="taem-content">
                                                ...
                                                <div class="team-details">
                                                    <div class="taem-contentbox">
                                                        <p class="f-w-500"><a href="/ki-admin/project_app" target="_blank">Projects</a></p>
                                                        <p class="text-center">20</p>
                                                    </div>
                                                    <div class="taem-contentbox">
                                                        <p class="f-w-500"><a href="/ki-admin/to_do" target="_blank">Tasks</a></p>
                                  ...
                                  <span
                                      class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                    <img src="{{asset('../assets/images/avatar/15.png')}}" alt="" class="img-fluid b-r-50 ">
                                  </span>
                                                </div>
                                            </div>
                                            <div class="taem-content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                  ...
                                  <span
                                      class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                    <img src="{{asset('../assets/images/avatar/woman.jpg')}}" alt="" class="img-fluid b-r-50 ">
                                  </span>
                                                </div>
                                            </div>
                                            <div class="taem-content">
