                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center flex-wrap ">
                            <div class="h-50 w-50 d-flex-center b-r-10 overflow-hidden">
                                <img src="{{asset('../assets/images/avatar/09.png')}}" alt="" class="bg-danger img-fluid">
                            </div>
                        ...
                        <div class="blogcomment-box mb-3">
                            <div class="d-flex justify-content-between">
                                <div class="h-40 w-40 d-flex-center b-r-10 overflow-hidden comment-img">
                                    <img src="{{asset('../assets/images/avatar/4.png')}}" alt="avatar" class="bg-warning img-fluid">
                                </div>
                    ...
                    <div class="col-md-6 col-xxl-4">
                        <div class="card blog-card overflow-hidden">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/ki-admin/blog_details" class="bloglink">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body popular-blog-list">
                                <div class="position-relative mb-3">
                                    <div>
                                        <div class="position-absolute">
                                            <img src="{{asset('../assets/images/avatar/5.png')}}" alt="" class="w-40 h-40 bg-warning rounded">
                                        </div>
                                    </div>
                                    <div class="ms-5">
                                ...
                                <div class="position-relative mb-3">
                                    <div>
                                        <div class="position-absolute">
                                            <img src="{{asset('../assets/images/avatar/14.png')}}" alt="" class="w-40 h-40 bg-danger rounded">
                                        </div>
                                    </div>
                                    <div class="ms-5">
                                ...
                                <div class="position-relative mb-3">
                                    <div>
                                        <div class="position-absolute">
                                            <img src="{{asset('../assets/images/avatar/4.png')}}" alt="" class="w-40 h-40 bg-primary rounded">
                                        </div>
                                    </div>
                                    <div class="ms-5">
                                ...
                                <div class="position-relative mb-3">
                                    <div>
                                        <div class="position-absolute">
                                            <img src="{{asset('../assets/images/avatar/07.png')}}" alt="" class="w-40 h-40 bg-success rounded">
                                        </div>
                                    </div>
                                    <div class="ms-5">
                                ...
                                <div class="position-relative mb-3">
                                    <div>
                                        <div class="position-absolute">
                                            <img src="{{asset('../assets/images/avatar/09.png')}}" alt="" class="w-40 h-40 bg-dark rounded">
                                        </div>
                                    </div>
                                    <div class="ms-5">
                                ...
                                <div class="mt-3">
                                    <a href="/ki-admin/blog" target="_blank" role="button" class="btn btn-md btn-primary w-100">
