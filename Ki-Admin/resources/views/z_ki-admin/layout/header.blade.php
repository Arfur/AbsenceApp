                                ...
                                <div class="app-dropdown flex-shrink-0">
                                    ...
                                    <ul class="dropdown-menu mb-3">
                                        <li class="dropdown-item">
                                            <a href="/ki-admin/setting" target="_blank">
                                                Privacy Settings
                                            </a>
                                        </li>
                                        <li class="dropdown-item">
                                ...
                                <div class="head-container">
                                    <div class="head-box">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            <a class="mb-0 f-w-600 f-s-16" href="/ki-admin/product_details"
                                    ...
                                    <div class="hidden-massage py-4 px-3">
                                        ...
                                        <div>
                                            ...
                                            <a class="btn btn-light-primary btn-xs mt-2"
                                               href="/ki-admin/product_details">Shop
                                                Now</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="offcanvas-footer">
                                <div class="head-box-footer p-3">
                                    ...
                                    <div class="header-cart-btn">
                                        <a class="btn btn-primary" href="/ki-admin/cart" role="button"
                                           target="_blank">
                                            <i class="ti ti-eye"></i> View Cart</a>
                                        <a class="btn btn-success" href="/ki-admin/checkout" role="button"
                                           target="_blank">
                            ...
                            <div class="offcanvas-body app-scroll p-0">
                                <div class="head-container">
                                    ...
                                    <div class="notification-message head-box">
                                        ...
                                        <div class="message-content-box flex-grow-1 pe-2">
                                            <a class="f-s-15 text-dark mb-0" href="/ki-admin/read_email">Hey
                                                <span
