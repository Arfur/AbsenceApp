                            ...
                            <table id="projectTable" class="display table-bottom-border app-data-table table-box-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-left align-items-center">
                                            <div class="h-30 w-30 d-flex-center b-r-50 overflow-hidden me-2">
                                                <img src="{{asset('assets/images/icons/language/logo11.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-left align-items-center">
                                            <div class="h-30 w-30 d-flex-center b-r-50 overflow-hidden me-2">
                                                <img src="{{asset('assets/images/icons/language/logo1.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-left align-items-center">
                                            <div class="h-30 w-30 d-flex-center b-r-50 overflow-hidden me-2">
                                                <img src="{{asset('assets/images/icons/language/logo5.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-left align-items-center">
                                            <div class="h-30 w-30 d-flex-center b-r-50 overflow-hidden me-2">
                                                <img src="{{asset('assets/images/icons/language/logo14.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-left align-items-center">
                                            <div class="h-30 w-30 d-flex-center b-r-50 overflow-hidden me-2">
                                                <img src="{{asset('assets/images/icons/language/logo13.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <div>
