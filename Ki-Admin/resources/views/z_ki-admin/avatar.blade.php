                    ...
                    <div class="card-body">
                        <div class="d-flex gap-3 flex-wrap">
                            ...
                            <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden text-bg-secondary">
                                <img src="{{asset('assets/images/avatar/2.png')}}" alt="avatar" class="img-fluid">
                            </div>
                            <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden text-bg-success">
                                <img src="{{asset('assets/images/avatar/3.png')}}" alt="avatar" class="img-fluid">
                            </div>
                            <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden text-bg-info">
                                <img src="{{asset('assets/images/avatar/4.png')}}" alt="avatar" class="img-fluid">
                            </div>
                            <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden text-bg-success">
                                <img src="{{asset('assets/images/avatar/5.png')}}" alt="avatar" class="img-fluid">
                            </div>
                            <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden text-bg-danger">
                                <img src="{{asset('assets/images/avatar/6.png')}}" alt="avatar" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
...
&lt;/div&gt;
                ...
                <div class="card equal-card">
                    ...
                    <div class="card-body">
                      ...
                      <span class="bg-danger h-45 w-45 d-flex-center b-r-50 position-relative">
                        <i class="fa-solid fa-user"></i>
                        <span
                            class="position-absolute top-5 start-1 p-1 bg-danger border border-light rounded-circle"></span>
                      </span>
                        ...
                        <img src="{{asset('assets/images/avatar/1.png')}}" alt="avatar" class="img-fluid b-r-50">
                        <span
                            class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                      </span>

                            <span class="bg-secondary h-45 w-45 d-flex-center b-r-50 position-relative">
                        <img src="{{asset('assets/images/avatar/4.png')}}" alt="avatar" class="img-fluid b-r-50">
                        <span
                            ...
                            <span class="bg-secondary h-45 w-45 d-flex-center b-r-50 position-relative">
                        <img src="{{asset('assets/images/avatar/6.png')}}" alt="avatar" class="img-fluid b-r-50">
                        <span
  ...
  &lt;div class="card-header"&gt;
     ...
     &lt;p class="text-muted"&gt;Radius avtar text in soft color example&lt;/p&gt;
    &lt;/div&gt;
       &lt;div class="card-body"&gt;
         &lt;div class="d-flex gap-3 flex-wrap"&gt;
          &lt;span class="bg-danger h-45 w-45 d-flex-center b-r-50 position-relative"&gt;
                        ...
                        <div class="d-flex gap-3 flex-wrap">
                          ...
                          <span
                              class="position-absolute top-0 start-2 p-1 bg-danger border border-light rounded-circle"></span>
                                    <img src="{{asset('assets/images/avatar/4.png')}}" alt="avatar" class="img-fluid b-r-50 overflow-hidden">
                                </li>
                          ...
                          <span
                              class="position-absolute top-0 start-2 p-1 bg-success border border-light rounded-circle"></span>
                                    <img src="{{asset('assets/images/avatar/1.png')}}" alt="avatar" class="img-fluid b-r-50 overflow-hidden">
                                </li>
                          ...
                          <span
                              class="position-absolute top-0 start-2 p-1 bg-warning border border-light rounded-circle"></span>
                                    <img src="{{asset('assets/images/avatar/2.png')}}" alt="avatar" class="img-fluid b-r-50 overflow-hidden">
                                </li>
                          ...
                          <span
                              class="position-absolute top-0 start-2 p-1 bg-info border border-light rounded-circle"></span>
                                    <img src="{{asset('assets/images/avatar/3.png')}}" alt="avatar" class="img-fluid b-r-50 overflow-hidden">
                                </li>
