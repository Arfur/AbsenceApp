                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="d-flex align-items-center gap-2">
                                                        <span class="b-1-light bg-primary-200 p-1 h-45 w-45 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                                                            <img alt="product"
                                                                 class="img-fluid"
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <button class="btn btn-danger h-35 w-35 d-flex-center b-r-6 p-0 decrement">
                                                    -
                                                </button>
                                                <input class="h-35 w-35 ms-1 me-1 border b-r-6 text-center count"
                                                       type="text"
                                                       value="1">
                                                <button class="btn btn-primary h-35 w-35 d-flex-center b-r-6 p-0 increment">
                                                    +
                                                </button>
                                            </div>
                                        </td>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div class="cart-details">
                                                    <p class="fs-6">
                                                        Jackets
                                                        for Woman</p>
                                                    <p class="f-w-500">Color: <span>Balck</span></p>
                                        ...
                                        <th scope="row">
                                            <div class="d-flex align-items-center gap-2">
                                                        <span class="b-1-light bg-primary-200 p-1 h-45 w-45 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                                                            <img alt="product"
                                                                 class="img-fluid"
                                                                 src="{{asset('../assets/images/header/cart/06.png')}}">
                                                        </span>
                          ...
                          <i class="ph-duotone  ph-gift f-s-35"></i>
                                ...
                                <div class="scratch-code-box">
                                    ...
                                    <div class="flex-shrink-0">
                                        <button class="btn btn-primary btn-sm b-r-24" id="copyBtn">copy</button>
                                    </div>
                                </div>
                                <div class="mt-3">
                        ...
                        <div class="card gift-card">
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <p class="text-secondary mt-2">Gift wrap and personalized message on card,
                                        Only for <span class="text-dark f-w-500"><b>$10.50 USD</b></span></p>
                                    <div class="cart-gift text-end mt-4">
                                        <button class="btn btn-primary">Add Gift</button>
                                    </div>
                                </div>
                                <!-- Gift -->
                            </div>
