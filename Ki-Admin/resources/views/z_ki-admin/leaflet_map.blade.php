        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="w-100 h-280" id="mobileMap"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="w-100 h-280" id="accessibleMap"></div>
                    </div>
                </div>
            </div>
            <!-- Accessible maps end  -->
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="w-100 h-280" id="markersMap"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="w-100 h-280" id="interactiveMap"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="w-100 h-280" id="customIconsMap"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="w-100 h-280" id="layersMap"></div>
                    </div>
                </div>
            </div>
