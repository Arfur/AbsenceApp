                    ...
                    <div class="card-body">
                        ...
                        <div class="data-list-box mt-3">
                            <div class="filebox">
                                <div class="d-flex align-items-center position-relative">
                                    <div class="position-absolute start-0">
                                        <img src="{{asset('../assets/images/icons/file-manager-icon/file.png')}}" class="w-35 h-35" alt="">
                                    </div>
                            ...
                            <div class="filebox">
                                <div class="d-flex align-items-center position-relative">
                                    <div class="position-absolute start-0">
                                        <img src="{{asset('../assets/images/icons/file-manager-icon/folder.png')}}" class="w-35 h-35" alt="">
                                    </div>
                                    <div class="flex-grow-1 mg-s-40">
                            ...
                            <div class="filebox">
                                <div class="d-flex align-items-center position-relative">
                                    <div class="position-absolute start-0">
                                        <img src="{{asset('../assets/images/icons/file-manager-icon/zip.png')}}" class="w-35 h-35" alt="">
                                    </div>
                                    <div class="flex-grow-1 mg-s-40">
                            ...
                            <div>
                                <a href="/ki-admin/file_manager" target="_blank" role="button" class="btn btn-primary w-100">View More</a>
                            </div>
                        </div>
                    </div>
                </div>
