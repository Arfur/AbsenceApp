        ...
        <div class="navbar navbar-expand-lg sticky-top landing-navbar px-3 position-fixed ">
            <div class="landing-navbar-container container-fluid">
                <a class="navbar-brand logo" href="#home">
                    <img alt="#" src="{{asset('../assets/images/logo/1.png')}}" class="w-200">
                </a>
                ...
                <div class="row landing-content">
                    <div class="col-xxl-8 offset-xxl-2 text-center position-relative">
                        ...
                        <div class="d-flex gap-3 justify-content-center my-5">
                            ...
                            <a class="btn btn-danger f-s-16 px-4 py-2 text-white" href="/ki-admin/index"
                               role="button"
        ...
        <div class="container p-0">
            <div class="language-box">
                <div class="language-box-item">
                    <a href="/ki-admin/index" class="primary-box bg-primary h-60 w-60 d-flex-center b-r-50"
                       data-bs-toggle="tooltip" data-bs-custom-class="custom-primary" data-bs-html="true"
                       data-bs-original-title="Laravel">
                        <img src="{{asset('../assets/images/landing/logo/21.png')}}" class="w-35" alt="lang">
                    </a>
                </div>
                <div class="language-box-item">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/index"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/project_dashboard"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/calendar"
                                                   role="button"
                                                   target="_blank">
                                                    <i class="ph-bold  ph-caret-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/profile"
                                                   role="button"
                                                   target="_blank">
                                                    <i class="ph-bold  ph-caret-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/team"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/chat"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/email"
                                                   role="button"
                                                   target="_blank">
                                                    <i class="ph-bold  ph-caret-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/product"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/to_do"
                                                   role="button"
                                                   target="_blank">
                                                    <i class="ph-bold  ph-caret-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/file_manager"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/blog"
                                                   role="button"
                                                   target="_blank">
                                                    <i class="ph-bold  ph-caret-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/alert"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/badges"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/buttons"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/dropdown"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/avatar"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary  icon-btn b-r-22" href="/ki-admin/accordions"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/progress"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/notifications"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/modals"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/sweetalert"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/animation"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/video_embed"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/tour"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/slick_slider"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/ratings"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/count_down"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/fontawesome"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/flag_icons"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/animated_icon"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/weather_icon"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/basic_table"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/data_table"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/list_table"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/advance_table"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/base_inputs"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/form_validation"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/checkbox_radio"
                                                   role="button"
                                                   target="_blank">
                                                    <i class="ph-bold  ph-caret-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/input_masks"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/floating_labels"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/select"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/range_slider"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/clipboard"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/file_upload"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-danger icon-btn b-r-22" href="/ki-admin/dual_list_boxes"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/default_forms"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/form_wizards"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/form_wizard_1"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/form_wizard_2"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/ready_to_use_form"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right"></i>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22"
                                                   href="/ki-admin/ready_to_use_table" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/sign_in"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/sign_in_1"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/sign_up"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/sign_up_1"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/password_create"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/password_reset"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/lock_screen"
                                                   role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22"
                                                   href="/ki-admin/two_step_verification" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/error_400"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/error_403"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right f-s-18 f-w-900"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/error_404"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right f-s-18 f-w-900"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/error_500"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right f-s-18 f-w-900"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-primary icon-btn b-r-22" href="/ki-admin/error_503"
                                                   role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ph-bold  ph-caret-right f-s-18 f-w-900"></i>
                    ...
                    <div class="col-12">
                        <ul class="features-box-list">
                            <li class="d-flex-center">
                                <img alt="features-icon" class="img-fluid" src="{{asset('../assets/images/landing/logo/01.png')}}">
                            </li>
                            <li class="d-flex-center">
                        ...
                        <ul class="features-box-list">
                            <li class="d-flex-center">
                                <img alt="features-icon" class="img-fluid" src="{{asset('../assets/images/landing/logo/11.png')}}">
                            </li>
                            <li class="d-flex-center">
                            ...
                            <div class="element-card ">
                                ...
                                <div>
                                    <p class="f-s-16 txt-ellipsis-2 text-white-800 mb-3">Apply Custom button styles to
                                        ...
                                        states.</p>
                                    <a class="link-btn btn btn-light-white" href="/ki-admin/buttons" role="button"
                        ...
                        <div class="card-body">
                            <div class="element-card ">
                                ...
                                <div>
                                    ...
                                    <a class="link-btn btn btn-light-white" href="/ki-admin/cards" role="button"
                        ...
                        <div class="card-body">
                            <div class="element-card ">
                                ...
                                <div>
                                    ...
                                    <a class="link-btn btn btn-light-white" href="/ki-admin/list" role="button"
                        ...
                        <div class="card-body">
                            <div class="element-card ">
                                ...
                                <div>
                                    ...
                                    <a class="link-btn btn btn-light-white" href="/ki-admin/alert" role="button"
                        ...
                        <div class="card-body">
                            <div class="element-card ">
                                ...
                                <div>
                                    ...
                                    <a class="link-btn btn btn-light-white" href="/ki-admin/accordions" role="button"
