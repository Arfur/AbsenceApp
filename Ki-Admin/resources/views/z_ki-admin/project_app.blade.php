                                ...
                                <div class="card hover-effect" id="card1">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="/ki-admin/project_details" target="_blank" class="flex-grow-1 ps-2">
                            ...
                            <div class="col-md-6 col-xl-4 project-card">
                                <div class="card hover-effect">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center">
                                            <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden">
                                                <img src="{{asset('../assets/images/icons/language/logo3.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <a href="/ki-admin/project_details" target="_blank" class="flex-grow-1 ps-2">
                                                <h6 class="m-0 text-dark f-w-600"> Designing</h6>
                            ...
                            <div class="col-md-6 col-xl-4 project-card">
                                <div class="card hover-effect">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center">
                                            <div class="h-40 w-40 d-flex-center b-r-50 overflow-hidden">
                                                <img src="{{asset('../assets/images/icons/language/logo6.png')}}" alt="" class="img-fluid">
                                            </div>
                                            <a href="/ki-admin/project_details" target="_blank" class="flex-grow-1 ps-2">
                                                <h6 class="m-0 text-dark f-w-600">Designing</h6>
