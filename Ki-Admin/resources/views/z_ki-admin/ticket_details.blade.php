                        ...
                        <div class="ticket-details-profile mb-4 p-3 rounded-3">
                            <div class="ticket-profile">
                                <div class="h-45 w-45 d-flex-center b-r-50 overflow-hidden text-bg-secondary me-3">
                                    <img alt="" class="img-fluid " src="{{asset('../assets/images/avatar/2.png')}}">
                                </div>
                                <div>
                            ...
                            <div class="ticket-profile-con d-flex gap-3 justify-content-center mt-3">
                                             <span class="bg-success h-35 w-35 d-flex-center b-r-50">
                                               <i class="ph-bold ph-phone-call f-s-18"></i>
                                             </span>
                                <span class="bg-danger h-35 w-35 d-flex-center b-r-50">
                                               <i class="ph-bold  ph-arrow-square-out f-s-18 "></i>
                                             </span>
                                <span class="bg-info h-35 w-35 d-flex-center b-r-50">
                                               <i class="ph-bold  ph-user f-s-18"></i>
                                             </span>
