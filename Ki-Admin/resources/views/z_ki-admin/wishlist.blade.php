                        ...
                        <div class="product-content-box">
                            <div class="product-grid">
                                <div class="product-image">
                                    <a href="/ki-admin/product" target="_blank" class="image">
                            ...
                            <div class="p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="/ki-admin/product_details" class="m-0 f-s-20 f-w-500">Jackets</a>
                            ...
                            <span class="bg-danger h-45 w-45 d-flex-center b-r-50 wishlist-like-icon">
                        <i class="ti ti-heart heart-icon text-light"></i>
                       </span>
                        </div>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body p-0">
                        <div class="product-content-box">
                            ...
                            <div class="p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="/ki-admin/product_details" class="m-0 f-s-20 f-w-500">Hoodie</a>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body p-0">
                        <div class="product-content-box">
                            ...
                            <div class="p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="/ki-admin/product_details" class="m-0 f-s-20 f-w-500">Jumpsuit</a>
                                    <p class="text-warning">4.2 <span class="text-warning"><i class="ti ti-star-filled"></i></span></p>
                                </div>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body p-0">
                        <div class="product-content-box">
                            ...
                            <div class="p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="/ki-admin/product_details" class="m-0 f-s-20 f-w-500">Shoes</a>
                                    <p class="text-warning">4.2 <span class="text-warning"><i class="ti ti-star-filled"></i></span></p>
                                </div>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body p-0">
                        <div class="product-content-box">
                            ...
                            <div class="p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="/ki-admin/product_details" class="m-0 f-s-20 f-w-500">Watch</a>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body p-0">
                        <div class="product-content-box">
                            ...
                            <div class="p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="/ki-admin/product_details" class="m-0 f-s-20 f-w-500">Sandals</a>
                                    <p class="text-warning">5.2 <span class="text-warning"><i class="ti ti-star-filled"></i></span></p>
                                </div>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body p-0">
                        <div class="product-content-box">
                            ...
                            <div class="p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="/ki-admin/product_details" class="m-0 f-s-20 f-w-500">Stylish Bag</a>
                                    <p class="text-warning">4.2 <span class="text-warning"><i class="ti ti-star-filled"></i></span></p>
                                </div>
