 ...
 * File Name : dashboard/dashboard-custom-save.blade.php
 * Author    : Michael Battle
 * Created On: 06/Aug/2025
 * Updated On: 11/Aug/2025
 * Description: Save Layout view showing minimal breadcrumb layout.
 * ========================================================= --}}

@extends('layout.master')
@section('title', 'Dashboard - Save Layout')
    ...
    <div class="row m-1 mt-2">
        <div class="col-12">
            ...
            <ul class="app-line-breadcrumbs mb-3">
                ...
                <li class="active">
                    <a href="#" class="f-s-14 f-w-500">Save Layout</a>
                </li>
            </ul>
        </div>
    </div>
