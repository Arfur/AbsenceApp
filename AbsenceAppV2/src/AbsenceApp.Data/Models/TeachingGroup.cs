...
===============================================================================
 ...
 Updated     : 2026-03-15
-------------------------------------------------------------------------------
 Purpose     : EF Core entity for the classes table (TABLE9).
               Represents a teaching group / form class within a school.
-------------------------------------------------------------------------------
 Changes     :
...
/// <summary>
/// EF Core entity for SQL table dbo.teachinggroups (TABLE9).
/// </summary>
