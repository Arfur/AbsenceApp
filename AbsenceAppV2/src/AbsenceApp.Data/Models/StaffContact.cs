...
===============================================================================
 ...
 Updated     : 2026-04-28
-------------------------------------------------------------------------------
 Purpose     : EF Core entity for the `staffcontacts` table.
...
public sealed class StaffContact
{
    ...
    // Optional: contact type (email, phone, etc.)
    public string? ContactType { get; set; }

    // Optional: contact value
