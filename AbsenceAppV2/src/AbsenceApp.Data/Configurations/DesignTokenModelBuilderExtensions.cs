        ...
        modelBuilder.Entity<DesignToken>(b =>
        {
            ...
            b.HasData(
                ...
                new DesignToken
                {
                    Id             = 13,
                    ComponentGroup = "btn",
                    TokenKey       = "primary-bg-hover",
                    CssVariable    = "--ds-btn-primary-bg-hover",
                    DefaultValue   = "#0b5ed7",
                    Category       = "color",
                ...
                new DesignToken
                {
                    Id             = 23,
                    ComponentGroup = "btn",
                    TokenKey       = "secondary-bg-hover",
                    CssVariable    = "--ds-btn-secondary-bg-hover",
                    DefaultValue   = "#f8f9fa",
                    Category       = "color",
                ...
                new DesignToken
                {
                    Id             = 33,
                    ComponentGroup = "btn",
                    TokenKey       = "success-bg-hover",
                    CssVariable    = "--ds-btn-success-bg-hover",
                    DefaultValue   = "#157347",
                    Category       = "color",
                ...
                new DesignToken
                {
                    Id             = 43,
                    ComponentGroup = "btn",
                    TokenKey       = "danger-bg-hover",
                    CssVariable    = "--ds-btn-danger-bg-hover",
                    DefaultValue   = "#bb2d3b",
                    Category       = "color",
                ...
                new DesignToken
                {
                    Id             = 53,
                    ComponentGroup = "btn",
                    TokenKey       = "warning-bg-hover",
                    CssVariable    = "--ds-btn-warning-bg-hover",
                    DefaultValue   = "#ffca2c",
                    Category       = "color",
                ...
                new DesignToken
                {
                    Id             = 63,
                    ComponentGroup = "btn",
                    TokenKey       = "info-bg-hover",
                    CssVariable    = "--ds-btn-info-bg-hover",
                    DefaultValue   = "#31d2f2",
                    Category       = "color",
                ...
                new DesignToken
                {
                    Id             = 70,
                    ComponentGroup = "btn",
                    TokenKey       = "structure-radius",
                    CssVariable    = "--ds-btn-structure-radius",
                    DefaultValue   = "6px",
                    Category       = "structure",
                ...
                new DesignToken
                {
                    Id             = 71,
                    ComponentGroup = "btn",
                    TokenKey       = "structure-font-size",
                    CssVariable    = "--ds-btn-structure-font-size",
                ...
                new DesignToken
                {
                    Id             = 72,
                    ComponentGroup = "btn",
                    TokenKey       = "structure-padding-y",
                    CssVariable    = "--ds-btn-structure-padding-y",
                    DefaultValue   = "7px",
                    Category       = "structure",
                ...
                new DesignToken
                {
                    Id             = 73,
                    ComponentGroup = "btn",
                    TokenKey       = "structure-padding-x",
                    CssVariable    = "--ds-btn-structure-padding-x",
                    DefaultValue   = "16px",
                    Category       = "structure",
                ...
                new DesignToken
                {
                    Id             = 101,
                    ComponentGroup = "card",
                    TokenKey       = "base-border",
                    CssVariable    = "--ds-card-base-border",
                    DefaultValue   = "#dee2e6",
                    Category       = "color",
                ...
                new DesignToken
                {
                    ...
                    ComponentGroup = "card",
                    TokenKey       = "structure-radius",
                    CssVariable    = "--ds-card-structure-radius",
                    DefaultValue   = "8px",
                    Category       = "structure",
                ...
                new DesignToken
                {
                    Id             = 103,
                    ComponentGroup = "card",
                    TokenKey       = "structure-shadow",
                    CssVariable    = "--ds-card-structure-shadow",
                ...
                new DesignToken
                {
                    Id             = 105,
                    ComponentGroup = "card",
                    TokenKey       = "structure-padding",
                    CssVariable    = "--ds-card-structure-padding",
                ...
                new DesignToken { Id = 604, ComponentGroup = "nav-sidebar", TokenKey = "bg-hover",   CssVariable = "--ds-nav-sidebar-bg-hover", DefaultValue = "TBD", Category = "color", Description = "Sidebar hover background", IsActive = true, SortOrder = 604, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 605, ComponentGroup = "nav-sidebar", TokenKey = "bg-active",  CssVariable = "--ds-nav-sidebar-bg-active", DefaultValue = "TBD", Category = "color", Description = "Sidebar active background", IsActive = true, SortOrder = 605, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 606, ComponentGroup = "nav-sidebar", TokenKey = "text-active", CssVariable = "--ds-nav-sidebar-text-active", DefaultValue = "TBD", Category = "color", Description = "Sidebar active text color", IsActive = true, SortOrder = 606, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 650, ComponentGroup = "input", TokenKey = "base-bg",           CssVariable = "--ds-input-base-bg", DefaultValue = "TBD", Category = "color", Description = "Form field background", IsActive = true, SortOrder = 650, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 651, ComponentGroup = "input", TokenKey = "base-text",         CssVariable = "--ds-input-base-text", DefaultValue = "TBD", Category = "color", Description = "Form field text color", IsActive = true, SortOrder = 651, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 652, ComponentGroup = "input", TokenKey = "base-border",       CssVariable = "--ds-input-base-border", DefaultValue = "TBD", Category = "color", Description = "Form field border color", IsActive = true, SortOrder = 652, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 653, ComponentGroup = "input", TokenKey = "base-placeholder",  CssVariable = "--ds-input-base-placeholder", DefaultValue = "TBD", Category = "color", Description = "Form field placeholder color", IsActive = true, SortOrder = 653, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 654, ComponentGroup = "input", TokenKey = "base-border-focus", CssVariable = "--ds-input-base-border-focus", DefaultValue = "TBD", Category = "color", Description = "Form field focus border", IsActive = true, SortOrder = 654, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 655, ComponentGroup = "input", TokenKey = "base-ring-focus",   CssVariable = "--ds-input-base-ring-focus", DefaultValue = "TBD", Category = "shadow", Description = "Form field focus ring shadow", IsActive = true, SortOrder = 655, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 656, ComponentGroup = "input", TokenKey = "base-border-error", CssVariable = "--ds-input-base-border-error", DefaultValue = "TBD", Category = "color", Description = "Form field error border", IsActive = true, SortOrder = 656, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 657, ComponentGroup = "input", TokenKey = "base-text-error",   CssVariable = "--ds-input-base-text-error", DefaultValue = "TBD", Category = "color", Description = "Form field error text", IsActive = true, SortOrder = 657, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 658, ComponentGroup = "input", TokenKey = "base-label",        CssVariable = "--ds-input-base-label", DefaultValue = "TBD", Category = "color", Description = "Form label text color", IsActive = true, SortOrder = 658, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 659, ComponentGroup = "input", TokenKey = "base-hint",         CssVariable = "--ds-input-base-hint", DefaultValue = "TBD", Category = "color", Description = "Form hint text color", IsActive = true, SortOrder = 659, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 660, ComponentGroup = "input", TokenKey = "base-bg-disabled",  CssVariable = "--ds-input-base-bg-disabled", DefaultValue = "TBD", Category = "color", Description = "Form field disabled state", IsActive = true, SortOrder = 660, CreatedAt = SeedDate, UpdatedAt = SeedDate },

                // ── Form Shell (IDs 700–704) ───────────────────────────────────────────
                new DesignToken { Id = 700, ComponentGroup = "input-shell", TokenKey = "bg",         CssVariable = "--ds-input-shell-bg", DefaultValue = "TBD", Category = "color", Description = "Form shell background", IsActive = true, SortOrder = 700, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 701, ComponentGroup = "input-shell", TokenKey = "border",     CssVariable = "--ds-input-shell-border", DefaultValue = "TBD", Category = "color", Description = "Form shell border color", IsActive = true, SortOrder = 701, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 702, ComponentGroup = "input-shell", TokenKey = "shadow",     CssVariable = "--ds-input-shell-shadow", DefaultValue = "TBD", Category = "shadow", Description = "Form shell shadow", IsActive = true, SortOrder = 702, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 703, ComponentGroup = "input-shell", TokenKey = "text-muted", CssVariable = "--ds-input-shell-text-muted", DefaultValue = "TBD", Category = "color", Description = "Form shell muted text", IsActive = true, SortOrder = 703, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 704, ComponentGroup = "input-shell", TokenKey = "action-bg",  CssVariable = "--ds-input-shell-action-bg", DefaultValue = "TBD", Category = "color", Description = "Form shell action area background", IsActive = true, SortOrder = 704, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 753, ComponentGroup = "table", TokenKey = "row-bg-hover",    CssVariable = "--ds-table-row-bg-hover", DefaultValue = "TBD", Category = "color", Description = "Table row hover background", IsActive = true, SortOrder = 753, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 754, ComponentGroup = "table", TokenKey = "base-border",     CssVariable = "--ds-table-base-border", DefaultValue = "TBD", Category = "color", Description = "Table border color", IsActive = true, SortOrder = 754, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 755, ComponentGroup = "table", TokenKey = "base-surface",    CssVariable = "--ds-table-base-surface", DefaultValue = "TBD", Category = "color", Description = "Table surface color", IsActive = true, SortOrder = 755, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 756, ComponentGroup = "table", TokenKey = "base-text-muted",  CssVariable = "--ds-table-base-text-muted", DefaultValue = "TBD", Category = "color", Description = "Table muted text", IsActive = true, SortOrder = 756, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 812, ComponentGroup = "alert", TokenKey = "structure-shadow", CssVariable = "--ds-alert-structure-shadow", DefaultValue = "TBD", Category = "shadow", Description = "Alert shadow", IsActive = true, SortOrder = 812, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 813, ComponentGroup = "alert", TokenKey = "structure-radius", CssVariable = "--ds-alert-structure-radius", DefaultValue = "TBD", Category = "radius", Description = "Alert border radius", IsActive = true, SortOrder = 813, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 900, ComponentGroup = "icon-btn", TokenKey = "structure-gap",          CssVariable = "--ds-icon-btn-structure-gap", DefaultValue = "TBD", Category = "spacing", Description = "Icon button content gap", IsActive = true, SortOrder = 900, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 901, ComponentGroup = "icon-btn", TokenKey = "structure-radius",       CssVariable = "--ds-icon-btn-structure-radius", DefaultValue = "TBD", Category = "radius", Description = "Icon button border radius", IsActive = true, SortOrder = 901, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 902, ComponentGroup = "icon-btn", TokenKey = "structure-font-size-sm", CssVariable = "--ds-icon-btn-structure-font-size-sm", DefaultValue = "TBD", Category = "typography", Description = "Small icon button font size", IsActive = true, SortOrder = 902, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 903, ComponentGroup = "icon-btn", TokenKey = "structure-font-size-md", CssVariable = "--ds-icon-btn-structure-font-size-md", DefaultValue = "TBD", Category = "typography", Description = "Medium icon button font size", IsActive = true, SortOrder = 903, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 904, ComponentGroup = "icon-btn", TokenKey = "structure-font-size-lg", CssVariable = "--ds-icon-btn-structure-font-size-lg", DefaultValue = "TBD", Category = "typography", Description = "Large icon button font size", IsActive = true, SortOrder = 904, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 905, ComponentGroup = "icon-btn", TokenKey = "structure-padding-sm",   CssVariable = "--ds-icon-btn-structure-padding-sm", DefaultValue = "TBD", Category = "spacing", Description = "Small icon button padding", IsActive = true, SortOrder = 905, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 906, ComponentGroup = "icon-btn", TokenKey = "structure-padding-md",   CssVariable = "--ds-icon-btn-structure-padding-md", DefaultValue = "TBD", Category = "spacing", Description = "Medium icon button padding", IsActive = true, SortOrder = 906, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 907, ComponentGroup = "icon-btn", TokenKey = "structure-padding-lg",   CssVariable = "--ds-icon-btn-structure-padding-lg", DefaultValue = "TBD", Category = "spacing", Description = "Large icon button padding", IsActive = true, SortOrder = 907, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 909, ComponentGroup = "icon-btn", TokenKey = "ghost-bg-hover",         CssVariable = "--ds-icon-btn-ghost-bg-hover", DefaultValue = "TBD", Category = "color", Description = "Ghost icon button hover background", IsActive = true, SortOrder = 909, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 911, ComponentGroup = "icon-btn", TokenKey = "primary-bg-hover",       CssVariable = "--ds-icon-btn-primary-bg-hover", DefaultValue = "TBD", Category = "color", Description = "Primary icon button hover background", IsActive = true, SortOrder = 911, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 913, ComponentGroup = "icon-btn", TokenKey = "danger-bg-hover",        CssVariable = "--ds-icon-btn-danger-bg-hover", DefaultValue = "TBD", Category = "color", Description = "Danger icon button hover background", IsActive = true, SortOrder = 913, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 914, ComponentGroup = "icon-btn", TokenKey = "base-text",              CssVariable = "--ds-icon-btn-base-text", DefaultValue = "TBD", Category = "color", Description = "Icon button text color", IsActive = true, SortOrder = 914, CreatedAt = SeedDate, UpdatedAt = SeedDate },

                // ── Badge Status (IDs 950–957) ──────────────────────────────────────────
                new DesignToken { Id = 950, ComponentGroup = "badge-status", TokenKey = "active-bg",         CssVariable = "--ds-badge-status-active-bg", DefaultValue = "TBD", Category = "color", Description = "Active badge background", IsActive = true, SortOrder = 950, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 951, ComponentGroup = "badge-status", TokenKey = "active-text",       CssVariable = "--ds-badge-status-active-text", DefaultValue = "TBD", Category = "color", Description = "Active badge text", IsActive = true, SortOrder = 951, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 952, ComponentGroup = "badge-status", TokenKey = "inactive-bg",       CssVariable = "--ds-badge-status-inactive-bg", DefaultValue = "TBD", Category = "color", Description = "Inactive badge background", IsActive = true, SortOrder = 952, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 953, ComponentGroup = "badge-status", TokenKey = "inactive-text",     CssVariable = "--ds-badge-status-inactive-text", DefaultValue = "TBD", Category = "color", Description = "Inactive badge text", IsActive = true, SortOrder = 953, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 954, ComponentGroup = "badge-status", TokenKey = "planned-bg",         CssVariable = "--ds-badge-status-planned-bg", DefaultValue = "TBD", Category = "color", Description = "Planned badge background", IsActive = true, SortOrder = 954, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 955, ComponentGroup = "badge-status", TokenKey = "planned-text",       CssVariable = "--ds-badge-status-planned-text", DefaultValue = "TBD", Category = "color", Description = "Planned badge text", IsActive = true, SortOrder = 955, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 956, ComponentGroup = "badge-status", TokenKey = "structure-radius",   CssVariable = "--ds-badge-status-structure-radius", DefaultValue = "TBD", Category = "radius", Description = "Badge border radius", IsActive = true, SortOrder = 956, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 957, ComponentGroup = "badge-status", TokenKey = "structure-font-size", CssVariable = "--ds-badge-status-structure-font-size", DefaultValue = "TBD", Category = "typography", Description = "Badge font size", IsActive = true, SortOrder = 957, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 1101, ComponentGroup = "action-btn", TokenKey = "primary-bg-hover",   CssVariable = "--ds-action-btn-primary-bg-hover", DefaultValue = "TBD", Category = "color",      Description = "Action button primary hover background",   IsActive = true, SortOrder = 1101, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 1105, ComponentGroup = "action-btn", TokenKey = "secondary-bg-hover",  CssVariable = "--ds-action-btn-secondary-bg-hover", DefaultValue = "TBD", Category = "color", Description = "Action button secondary hover background", IsActive = true, SortOrder = 1105, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                ...
                new DesignToken { Id = 1109, ComponentGroup = "action-btn", TokenKey = "structure-padding-x", CssVariable = "--ds-action-btn-structure-padding-x",        DefaultValue = "TBD", Category = "spacing",    Description = "Action button horizontal padding",        IsActive = true, SortOrder = 1109, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 1110, ComponentGroup = "action-btn", TokenKey = "structure-padding-y", CssVariable = "--ds-action-btn-structure-padding-y",        DefaultValue = "TBD", Category = "spacing",    Description = "Action button vertical padding",          IsActive = true, SortOrder = 1110, CreatedAt = SeedDate, UpdatedAt = SeedDate },
                new DesignToken { Id = 1111, ComponentGroup = "action-btn", TokenKey = "structure-font-size", CssVariable = "--ds-action-btn-structure-font-size",        DefaultValue = "TBD", Category = "typography", Description = "Action button default font size",         IsActive = true, SortOrder = 1111, CreatedAt = SeedDate, UpdatedAt = SeedDate },
