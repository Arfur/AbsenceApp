...
-------------------------------------------------------------------------------
 Purpose     : ViewModel for StaffProfilePageV2. Provides staff profile data
               across 5 tabs with full view / edit / add mode support.
               Avatar upload and absence CRUD included.
-------------------------------------------------------------------------------
 Changes     :
...
public sealed class StaffProfileViewModelV2
{
    ...
    /// <summary>Initialise for Add (new staff) mode.</summary>
    ...
    /// <summary>Start editing an existing (already loaded) staff member.</summary>
