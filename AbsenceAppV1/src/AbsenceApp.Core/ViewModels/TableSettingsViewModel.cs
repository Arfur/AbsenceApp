...
-------------------------------------------------------------------------------
 Changes     :
    ...
    - 1.1.0  2026-03-18  Defaulted SelectedPage to students_full for the
                                Full View Table Settings experience.
===============================================================================
*/
...
public class TableSettingsViewModel
{
    ...
    public string                    SelectedPage { get; private set; } = "students_full";
